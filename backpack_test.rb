...
class BackpackTest < MiniTest::Test
  ...
  def test_packing_list
    ...
    puts melindas.print_summary_packing_list
  end
  ...
  def test_that_gym_shoes_are_there_when_mondays_and_thursdays
...
- gym shoes
- packed lunch"
    assert_equal(backpack.print_summary_packing_list, expected)
  end
